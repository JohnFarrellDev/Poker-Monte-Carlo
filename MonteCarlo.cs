...
namespace poker_monte_carlo
{
    class MonteCarlo
    {
        ...
        public static void MonteCarloSimulation(int numnberOfSimulations, List<Card> cardsStillInDeckOfCardList, List<Card> knownSharedCards, Player player, int numberOfOppoents, int numberOfFoldedOpponents)
        {
        ...
        public static void ReturnChanceOfWinning()
        {
